...
/*
   try {
                System.out.println("Pseudo conducteur : " + strNameUser);
                HashMap<String, String> pseudoConducteur = new HashMap<>();
                pseudoConducteur.put("PSEUDO_CONDUCTEUR_NOTIF", strNameUser);
                performPostCall(AddressUrl.strNotification, pseudoConducteur);
